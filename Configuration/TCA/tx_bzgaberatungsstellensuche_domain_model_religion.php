...
return array(
    'ctrl' => array(
        'title' => 'LLL:EXT:bzga_beratungsstellensuche/Resources/Private/Language/locallang_db.xlf:tx_bzgaberatungsstellensuche_domain_model_religiousdenomination',
        'label' => 'title',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
    ...
    'columns' => array(
        ...
        'l10n_parent' => array(
            ...
            'config' => array(
                ...
                'foreign_table_where' => 'AND tx_bzgaberatungsstellensuche_domain_model_religion.pid=###CURRENT_PID### AND tx_bzgaberatungsstellensuche_domain_model_religion.sys_language_uid IN (-1,0)',
            ),
        ),
        ...
        'title' => array(
            'exclude' => 0,
            'label' => 'LLL:EXT:bzga_beratungsstellensuche/Resources/Private/Language/locallang_db.xlf:tx_bzgaberatungsstellensuche_domain_model_religiousdenomination.title',
            'config' => array(
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim,required',
